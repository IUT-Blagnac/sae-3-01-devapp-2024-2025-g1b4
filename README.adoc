...
- https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g1b4/blob/master/.github/docTechnique.pdf[Documentation utilisateur]
...
- https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g1b4/tree/master/.github/GPO/Analyse[Liens vers les Analyses de réunion]
...
US toujours non éclatées en tâches, pas de milestone. Remarques précédentes non prises en compte. doc tech et user pointent vers le même document  ! Test OK. J'aurai aimé un lien vers le site ... attention vous avez un lien vers une release obsolète dans le readme
note provisoire : 7,36/20
note fiche synthèse droit : 12/20
