...
* Chaque US sont assigné à une personne et à un Sprint. Ils sont consultable https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g1b4/issues[ici], et pour avoir les détails sur une US, il faut dérouler le petit menu *Projects* sur la droite.
